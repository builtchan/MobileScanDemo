...
#ifndef soapSLEWebServiceSoapProxy_H
#define soapSLEWebServiceSoapProxy_H
#include "soapH.h"

class SOAP_CMAC SLEWebServiceSoapProxy : public soap
{ public:
	/// Endpoint URL of service 'SLEWebServiceSoapProxy' (change as needed)
	const char *soap_endpoint;
	/// Constructor
	SLEWebServiceSoapProxy();
	/// Constructor with copy of another engine state
	SLEWebServiceSoapProxy(const struct soap&);
	/// Constructor with endpoint URL
	SLEWebServiceSoapProxy(const char *url);
	/// Constructor with engine input+output mode control
	SLEWebServiceSoapProxy(soap_mode iomode);
	/// Constructor with URL and input+output mode control
	SLEWebServiceSoapProxy(const char *url, soap_mode iomode);
	/// Constructor with engine input and output mode control
	SLEWebServiceSoapProxy(soap_mode imode, soap_mode omode);
	/// Destructor frees deserialized data
	virtual	~SLEWebServiceSoapProxy();
	/// Initializer used by constructors
	virtual	void SLEWebServiceSoapProxy_init(soap_mode imode, soap_mode omode);

...
public:
	...
	static void GetMD5(const BYTE* pBuf, DWORD nLength, BYTE * md5);
protected:
	...
	//utility functions
	void DWordToByte(BYTE* Output, const DWORD* Input, DWORD nLength);
	void ByteToDWord(DWORD* Output, const BYTE* Input, DWORD nLength);
